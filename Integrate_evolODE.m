...
if matlabflag
  ...
  save('-ascii', [outputdir '/ksample.dat'], 'ksampletab');
end
...
for isample=1:Nsample  %% this loop takes a long while!!
  ...
  stroutD    = [outputdir '/Deltas_1Dmu_k' num2str(ksample)];
  stroutD    = [stroutD   '_ic' num2str(ic) '_jc' num2str(jc) '_kc' num2str(kc) '-muhalf.matbin'];

  strTHoutD  = [outputdir '/Deltas_TH_1Dmu_k' num2str(ksample)];
